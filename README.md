...
- 只有当实例被创建时data中存在的属性才是响应式的，也就是说如果你自己添加一个新的属性改变时不会触发任何属性的更新
- Mustache 语法不能作用在 HTML 特性上，遇到这种情况应该使用 v-bind 指令

列表渲染

- 利用索引直接改变数组的一个项时，绑定的数据不会触发重新刷新

### 基础能力已经具备，一些基础能力的体验和编写存放在save-init这个分之中，体验基础能力可以切换到此分枝,接下来开始vue开发工程化的构建
-----------------------------------------------------------------------------  基础分割线 ------------------------------------------------------------------------------